...
Backend: Java, Spring Boot, JDBC, JavaMailSender, Thymeleaf, Flyway для миграций, написаны тесты для основных сервисов
База данных: Postgres
Хранилище: API Яндекс Диска
Инфраструктура: Docker
Безопасность передачи: сервер настроен на прием и передачу HTTP и HTTPS запросов, есть сертификат от Let's Encrypt.
Также написан фронтенд для сайта с использованием React (TSX, scss, antd для компонент)
